  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_principal_zero",
      },
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_down_neg",
      },
    ...
    divider("$t:enamel_div_plan_interest", "divider_plan_interest", "percent"),
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_apr",
      },
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_interest_pair",
      },
      schema: {},
    },
    {
    ...
    divider("$t:enamel_div_plan_schedule", "divider_plan_schedule", "calendar_month"),
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_schedule_pair",
      },
      schema: {},
    },
    {
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_days",
      },
      schema: {},
    },
    status(
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "$t:enamel_vm_working_days",
      },
      schema: {},
    },
    ...timestamps(),
