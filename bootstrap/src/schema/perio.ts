  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "A screening cannot have happened in the future.",
      },
      schema: { is_nullable: false },
    },
    {
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "BPE codes run 0 to 4. Leave empty for a sextant that was not scored.",
      },
      schema: {},
    },
    {
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "A sextant holds at most eight teeth.",
      },
      schema: {},
    },
    {
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        interface: "datetime", required: true, width: "half",
        validation: { examined_on: { _lte: "$NOW" } },
        validation_message: "An examination cannot have happened in the future.",
      },
      schema: { is_nullable: false },
    },
    {
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message:
          "A periodontal chart records permanent teeth: ISO 3950 11–18, 21–28, 31–38, 41–48.",
      },
      schema: { is_nullable: false },
    },
    {
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "Mobility is graded 0 to 3.",
      },
      schema: {},
    },
    {
    ...
    ...(
      ...
      meta: {
        ...
        validation_message: "Furcation involvement is graded I to III.",
      },
      schema: {},
    })),
    ...timestamps(),
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        validation_message: "Probing depth in millimetres, 0 to 20. Leave empty for a site that was not probed.",
      },
      schema: {},
    },
    {
      ...
      meta: {
        ...
        validation_message:
          "Recession in millimetres: positive when the margin is apical to the CEJ, negative when coronal.",
      },
      schema: {},
    },
