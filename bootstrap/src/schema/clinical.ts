  ...
  fields: [
    ...
    { field: "name", type: "string", meta: { interface: "input", required: true, width: "half" }, schema: { is_nullable: false } },
    {
      ...
      meta: {
        ...
        options: { choices: [
          { text: "$t:enamel_tc_diagnostic", value: "diagnostic" }, { text: "$t:enamel_tc_preventive", value: "preventive" },
          { text: "$t:enamel_tc_restorative", value: "restorative" }, { text: "$t:enamel_tc_endodontic", value: "endodontic" },
          { text: "$t:enamel_tc_periodontic", value: "periodontic" }, { text: "$t:enamel_tc_prosthodontic", value: "prosthodontic" },
          { text: "$t:enamel_tc_surgery", value: "surgery" }, { text: "$t:enamel_tc_orthodontic", value: "orthodontic" },
        ] },
      },
      schema: {},
    },
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        ...
        options: { choices: [
          { text: "$t:enamel_sf_mesial", value: "M" }, { text: "$t:enamel_sf_occlusal", value: "O" },
          { text: "$t:enamel_sf_distal", value: "D" }, { text: "$t:enamel_sf_buccal", value: "B" },
          { text: "$t:enamel_sf_lingual", value: "L" },
        ] },
      },
      schema: {},
    },
  ...
  fields: [
    ...
    },
    {
      ...
      meta: {
        interface: "select-dropdown", width: "half",
        options: { choices: [
          { text: "$t:enamel_sf_whole", value: "whole" }, { text: "$t:enamel_sf_mesial", value: "M" },
          { text: "$t:enamel_sf_occlusal", value: "O" }, { text: "$t:enamel_sf_distal", value: "D" },
          { text: "$t:enamel_sf_buccal", value: "B" }, { text: "$t:enamel_sf_lingual", value: "L" },
        ] },
      },
    ...
    },
    {
      ...
      meta: {
        ...
        options: { choices: [
          { text: "$t:enamel_cond_healthy", value: "healthy", color: "#2ECDA7" },
          { text: "$t:enamel_cond_caries", value: "caries", color: "#E35169" },
          { text: "$t:enamel_cond_filled", value: "filled", color: "#3399FF" },
          { text: "$t:enamel_cond_crown", value: "crown", color: "#FFC23B" },
          { text: "$t:enamel_cond_root_canal", value: "root_canal", color: "#A855F7" },
          { text: "$t:enamel_cond_implant", value: "implant", color: "#0D6E63" },
          { text: "$t:enamel_cond_missing", value: "missing", color: "#7A8B99" },
          { text: "$t:enamel_cond_fractured", value: "fractured", color: "#F97316" },
        ] },
      },
      schema: { is_nullable: false },
    },
